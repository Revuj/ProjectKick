...
insert into "user" (id, email, username, password, name, phone_number, photo_path, is_admin, country_id, creation_date, is_banned) values (DEFAULT, 'bajean1@mozilla.org', 'bajean1', 'qByRzSXy1', 'Brade Ajean', '734-k0@.com', 'admin', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'admin', '920-704-7512', DEFAULT, true, 75, '2018-12-01 02:22:06', false);576-9520', DEFAULT, false, 60, '2019-02-02 17:14:42', false);

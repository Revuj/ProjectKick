...
<div class="container mt-5 shadow-lg rounded">
    ...
    <div class="row">
      ...
      <div id="login-form" class="col-md-6 col-sm-8 login-form py-4 pr-5">
        <form class="d-flex flex-column" action="./project_overview.html">
          ...
          <div class="d-flex">
            <p class="ml-auto mb-2">Forgot Password?</p>
          </div>
          <div class="d-flex justify-content-end">
            <button type="submit" class="custom-button secondary-button" id="login-button">
              Login
            </button>
          </div>
